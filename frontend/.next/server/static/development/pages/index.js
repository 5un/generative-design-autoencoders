...
/***/ "./lib/model-generator.js":
/*!********************************!*\
  !*** ./lib/model-generator.js ***!
  \********************************/
/*! exports provided: generateModel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateModel", function() { return generateModel; });
...
var generateModel = function generateModel() {
  ...
  var model = _tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_0__["sequential"]();
  ...
  var xs = _tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_0__["tensor2d"]([1, 2, 3, 4], [4, 1]);
  var ys = _tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_0__["tensor2d"]([1, 3, 5, 7], [4, 1]); // Train the model using the data.

  model.fit(xs, ys, {
    epochs: 10
  }).then(function () {
    // Use the model to do inference on a data point the model hasn't seen before:
    model.predict(_tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_0__["tensor2d"]([5], [1, 1])).print(); // Open the browser devtools to see the output
  });
};
...
function (_React$Component) {
  ...
  function Index(props) {
    ...
    _this.state = {
      inputVec: lodash__WEBPACK_IMPORTED_MODULE_7___default.a.times(numFeatures, lodash__WEBPACK_IMPORTED_MODULE_7___default.a.constant(0.5))
    };
    return _this;
  }
...
module.exports = __webpack_require__(/*! /Users/Sun/Projects/135_AdvancedCG/Research/pyrender_examples/frontend/pages/index.js */"./pages/index.js");
